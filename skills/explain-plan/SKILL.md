...
1. If an Artifact-publishing tool exists in this session (Claude Code): write the filled HTML to a scratch file and publish it with favicon `🗺️` (never change it) and title from `{{TITLE}}`.
